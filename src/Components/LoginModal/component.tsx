    ...
    return <section className={classes.Container}>
        <div className={classes.Container__overlay}>
            <main className={classes.Container__overlay__body}>
                ...
                <section className={classes.Container__overlay__body__redirectContainer}>
                    <h5 className={classes.Container__overlay__body__redirectContainer__message}>Non sei ancora registrato?
                        <Link to={'/'} className={classes.Container__overlay__body__redirectContainer__message__link}>Registrati</Link>
                    </h5>
                </section>
                <section className={classes.Container__overlay__body__buttonsContainer}>
                    <a className={classes.Container__overlay__body__buttonsContainer__backButtonContainer}>
