...
export default function Card(props:CardProps){
    ...
    const URLtitle:string = props.repository.title.toLowerCase().split(" ").join("-")
    ...
    return <section className={classes.Card}>
            <div className={classes.toolbar}>
                ...
                <div className={classes.toolbar__addToCart} onClick={() => props.handleAddToCart(props.repository)}>
        ...
        <Link to={`/${URLtitle}`} className={classes.clickArea}>
            ...
            <picture className={classes.img_container}>
                <img src={props.repository.imageURL} alt={props.repository.title + "_picture"} className={classes.img_container__img} />
            </picture>
            <div className={classes.text_container}>
                ...
                <main className={classes.text_container__price}>
                    {props.repository.pricing.price}
                </main>
            </div>
        </Link>
    </section>
